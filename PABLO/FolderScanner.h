...
public:
    ...
    void scan(std::vector<std::string> & files){
        ...
        WIN32_FIND_DATAA find_data; // estrutura para armazenar informa��es sobre o arquivo encontrado
        ...
        if (hFind != INVALID_HANDLE_VALUE) {
            ...
            } while (FindNextFileA(hFind, &find_data)); // encontra o pr�ximo arquivo ou pasta na pasta especificada
