        ...
        while (window.pollEvent(event)) {
            ...
            if (event.type == sf::Event::MouseButtonPressed) {
                if (event.mouseButton.button == sf::Mouse::Left) {
                    ...
                    if(jogador.lButton.hover(mouse)){
                        jogador.lButton.setValue(!jogador.lButton.getValue());
                    }

                    if(jogador.rButton.hover(mouse)){
                        jogador.rButton.setValue(!jogador.rButton.getValue());
                    }
                    ...
                    if(jogador.negQficaGrande.hover(mouse, window)){

                        ONegocioQueFicaGrande & neg = jogador.negQficaGrande;
                        ...
                        jogador.tocador->setPosition(sf::seconds(jogador.tocador->getMusicDuration() * porcem));
                        jogador.tocador->music->pause();
                        jogador.tocador->music->play();

                        if(jogador.tocador->music->getStatus() != sf::Music::Playing){
                            jogador.tocador->music->play();
                        }
                        //jogador.tocador->music->setPosition(sf::seconds(150));
